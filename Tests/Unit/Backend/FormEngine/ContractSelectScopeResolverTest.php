...
final class ContractSelectScopeResolverTest extends UnitTestCase
{
     ...
     * TSconfig at all - on TYPO3 v13 from `AbstractItemProvider`, on v14 from
     * `ItemProcessingService`. Anything but an array has to mean "no restriction",
     * because a restriction that is guessed empties the select.
     *
