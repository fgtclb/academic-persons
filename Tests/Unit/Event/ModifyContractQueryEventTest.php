...
final class ModifyContractQueryEventTest extends UnitTestCase
{
    ...
    public function getQueryReturnsInstanceSetInConstructor(): void
    {
        ...
        $event = new ModifyContractQueryEvent($queryStub, null);
    ...
    public function getPluginControllerActionContextReturnsTheAcademicBaseContextSetInConstructor(): void
    {
        ...
        $event = new ModifyContractQueryEvent($this->createStub(QueryInterface::class), $contextStub);
    ...
    {
        $event = new ModifyContractQueryEvent($this->createStub(QueryInterface::class), null);
