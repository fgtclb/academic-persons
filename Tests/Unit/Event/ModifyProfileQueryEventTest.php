...
final class ModifyProfileQueryEventTest extends UnitTestCase
{
    ...
    public function getQueryReturnsInstanceSetInConstructor(): void
    {
        ...
        $event = new ModifyProfileQueryEvent($queryStub, null, null);
    ...
    public function getDemandReturnsInstanceSetInConstructor(): void
    {
        ...
        $event = new ModifyProfileQueryEvent($this->createStub(QueryInterface::class), $demandStub, null);
    ...
    {
        $event = new ModifyProfileQueryEvent($this->createStub(QueryInterface::class), null, null);
        $this->assertNull($event->getDemand());
    }

    #[Test]
    public function getPluginControllerActionContextReturnsTheAcademicBaseContextSetInConstructor(): void
    {
        $contextStub = $this->createStub(PluginControllerActionContextInterface::class);
        $event = new ModifyProfileQueryEvent($this->createStub(QueryInterface::class), null, $contextStub);
        $this->assertSame($contextStub, $event->getPluginControllerActionContext());
    }

    #[Test]
    public function getPluginControllerActionContextReturnsNullWhenNoneWasGiven(): void
    {
        $event = new ModifyProfileQueryEvent($this->createStub(QueryInterface::class), null, null);
        $this->assertNull($event->getPluginControllerActionContext());
    }
