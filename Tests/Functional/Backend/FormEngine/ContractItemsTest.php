...
final class ContractItemsTest extends AbstractAcademicPersonsTestCase
{
    ...
    public function itemsProcFuncReturnsExpectedDefaultItems(): void
    {
        ...
        $subject = new ContractItems();
        $invokeGetDefaultContractItems = new \ReflectionMethod($subject, 'getDefaultContractItems');
        $expectedDefaultItems = $invokeGetDefaultContractItems->invoke($subject, $this->fakeItemsProcFuncParameters(1, $site, 'fake_table', 'fake_field'));
     ...
     * }
     */
    private function fakeItemsProcFuncParameters(
        int $pageId,
        Site $site,
        string $tableName,
        string $fieldName,
     ...
     * `AbstractItemProvider::resolveItemProcessorFunction()`, which is the path on
