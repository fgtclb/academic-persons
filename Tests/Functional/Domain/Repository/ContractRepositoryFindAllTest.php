...
final class ContractRepositoryFindAllTest extends AbstractAcademicPersonsTestCase
{
     ...
     * the contract for the DBMS where the order was arbitrary before (ACE-491): on the 3.x
     * line PostgreSQL reversed comparable queries once an index gave its planner an
     * alternative.
     */
    #[Test]
