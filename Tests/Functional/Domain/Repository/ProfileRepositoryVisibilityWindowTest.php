...
final class ProfileRepositoryVisibilityWindowTest extends AbstractAcademicPersonsTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // an empty one is enough, the repository sets everything it relies on itself. Created
        // without its constructor, which takes two arguments on v12 and four on v13 - only the
        // setup array is read.
        $frontendTypoScript = (new \ReflectionClass(FrontendTypoScript::class))->newInstanceWithoutConstructor();
