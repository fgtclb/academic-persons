...
final class LocationRepositoryTest extends AbstractAcademicPersonsTestCase
{
     ...
     * DBMS, and every one of them happened to return insertion order — but PostgreSQL
     * promises none, and on the 3.x line an index added for workspaces (ACE-477) was
     * enough to reverse it. The assertion below is unchanged; what changed is that it is
     * now a promise rather than a coincidence.
     */
    #[Test]
