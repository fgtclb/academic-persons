...
final class ModifyContractQueryEvent
{
     ...
     * @param PluginControllerActionContextInterface|null $pluginControllerActionContext The plugin,
     *        its settings and the request, `null` for a caller outside the plugins.
     */
