 ...
 * stripped by `AbstractItemProvider::resolveItemProcessorFunction()`, on TYPO3 v12 and
 * v13 alike. It is `null` when the field has no such page TSconfig at all.
 */
final class ContractSelectScopeResolver
{
    /**
