...
if ((new \TYPO3\CMS\Core\Information\Typo3Version())->getMajorVersion() < 12) {
    ...
    $GLOBALS['TCA']['tx_academicpersons_domain_model_organisational_unit']['columns']['valid_from']['config'] = [
        'type' => 'input',
        'renderType' => 'inputDateTime',
        'eval' => 'date,int',
    ];
    $GLOBALS['TCA']['tx_academicpersons_domain_model_organisational_unit']['columns']['valid_to']['config'] = [
        'type' => 'input',
        'renderType' => 'inputDateTime',
        'eval' => 'date,int',
    ];
    ...
    foreach ($relatedColumnsForRemovedFalRelatedInlineApperanceFields as $column) {
        if (!isset($GLOBALS['TCA']['tx_academicpersons_domain_model_organisational_unit']['columns'][$column]['config']['type'])
            || $GLOBALS['TCA']['tx_academicpersons_domain_model_organisational_unit']['columns'][$column]['config']['type'] !== 'inline'
        ) {
            continue;
        }
        $GLOBALS['TCA']['tx_academicpersons_domain_model_organisational_unit']['columns'][$column]['config']['appearance']['fileUploadAllowed'] = false;
        $GLOBALS['TCA']['tx_academicpersons_domain_model_organisational_unit']['columns'][$column]['config']['appearance']['fileByUrlAllowed'] = false;
    }
}
